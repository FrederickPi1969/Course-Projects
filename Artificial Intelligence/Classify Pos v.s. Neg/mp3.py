...
#     parser.add_argument('--training', dest='training_dir', type=str, default = 'train',
#                         help='the directory of the training data')
#     parser.add_argument('--development', dest='development_dir', type=str, default = 'dev',
...
#     parser.add_argument('--lower_case',dest="lower_case", type=bool, default=True, 
#                         help='Convert all word to lower case')
#     parser.add_argument('--laplace',dest="laplace", type=float, default = 2.0,
...
if __name__ == "__main__":
    ...
    parser.add_argument('--lower_case',dest="lower_case", type=bool, default=True, 
                        help='Convert all word to lower case')
    parser.add_argument('--laplace',dest="laplace", type=float, default = 3.0,
                        help='Laplace smoothing parameter - default 1.0')
    parser.add_argument('--pos_prior',dest="pos_prior", type=float, default = 0.75,
                        help='Positive prior, i.e. Num_positive_comments / Num_comments')
    args = parser.parse_args()
